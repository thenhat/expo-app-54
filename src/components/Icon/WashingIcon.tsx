...
const Icon: React.FC<any> = (props) => {
  ...
  return (
    <Svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <Path d="M25.5555 24.4445L18.8889 29.4824" stroke={stroke} strokeWidth="2.2" strokeLinecap="round" />
      <Path d="M28.9897 26.6666L25.5555 29.4824" stroke={stroke} strokeWidth="2.2" strokeLinecap="round" />
